...
const CheckBox = React.memo((props) => { //props: initialVal
  ...
  return (
    <TouchableOpacity style={styles.touchableOpacity} onPress={handleOnRowSelect?.bind(null, !initialVal, info.id, info.name)} disabled={props?.disabled}>
      <View style={[styles.container, { backgroundColor: initialVal ? (props?.backgroundColor ? props?.backgroundColor : 'orange') : 'transparent', borderColor: props?.backgroundColor ? props?.backgroundColor : 'orange' }]}>
